...
const Add_product=(item)=>{
  ...
  return (
    <>
      <h1 style={{ textAlign: 'center' }}>Mens Product are here </h1>
      <div>
        <div className="latest-product-trend">
          <div className="product-container">
            {otherData.filter(item => item.category === 'Women' ).map((product, index) => (
              <Card className='card-new-arrival' style={{ width: '18rem' }}>
                ...
                <Card.Body>
                  ...
                  <Button variant="primary" style={{ color: 'white', fontWeight: 'bold' }} onClick={()=>Add_product(product)}>Order Now</Button>
                </Card.Body>
              </Card>
            ))}
          </div>
